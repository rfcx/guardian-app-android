...
class DateRangeFormatTest {
	...
	fun caseStartTodayAndEndToday() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "Today, 09:31 - 14:15")
	}
	...
	fun caseStartTodayAndEndTodayWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "Today, 01:31 - 02:15")
	}
	...
	fun caseStartYesterdayAndEndToday() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "Yesterday 17:31 - Today 14:25")
	}
	...
	fun caseStartYesterdayAndEndTodayWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "Yesterday 05:31 - Today 02:25")
	}
	...
	fun caseStartYesterdayAndEndYesterday() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "Yesterday, 08:31 - 14:45")
	}
	...
	fun caseStartYesterdayAndEndYesterdayWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "Yesterday, 14:31 - 16:45")
	}
	...
	fun caseStartOtherAndEndToday() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "08 Dec - Today, 14:45")
	}
	...
	fun caseStartOtherAndEndTodayWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "07 Dec - Today, 21:45")
	}
	...
	fun caseStartOtherAndEndYesterday() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "10 Dec - Yesterday, 19:45")
	}
	...
	fun caseStartOtherAndEndYesterdayWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "10 Dec - Yesterday, 00:45")
	}
	...
	fun caseStartOtherAndEndOther() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "10 Dec - 15 Dec")
	}
	...
	fun caseStartOtherAndEndOtherWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "10 Dec - 15 Dec")
	}
	...
	fun caseStartOtherAndEndOtherBySameDay() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt), "12 Dec, 03:31 - 08:45")
	}
	...
	fun caseStartOtherAndEndOtherBySameDayWithTimeZone() {
		...
		Assert.assertEquals(dateRangeFormat(context, startAt, endAt, timeZone), "11 Dec, 03:31 - 04:45")
	}
}
