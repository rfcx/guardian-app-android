...
class EditProfileViewModel(private val context: Context, private val profilePhotoUseCase: ProfilePhotoUseCase) :
    ViewModel() {
    ...
    fun updateProfilePhoto(path: String) {
        ...
        profilePhotoUseCase.execute(
            object : DisposableSingleObserver<ProfilePhotoResponse>() {
