...
object UiModule {
    ...
    val mainModule = module {
        viewModel { MainActivityViewModel(get(), androidContext(), get(), get(), get(), get(), get(), get(), get(), get()) }
    }
    ...
    var guardianModule = module {
        ...
        viewModel { DeploymentListViewModel(get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get()) }
