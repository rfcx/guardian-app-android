    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        newPasswordEditText.setOnFocusChangeListener { _, hasFocus ->
            if (!hasFocus) {
                ...
                when {
                    newPasswordEditText.text.isNullOrEmpty() -> errorNewPasswordTextView.text =
                        getString(R.string.please_enter_your_new_password)
                    newPasswordEditText.text!!.length < 6 -> errorNewPasswordTextView.text =
        ...
        newPasswordAgainEditText.setOnFocusChangeListener { _, hasFocus ->
            if (!hasFocus) {
                ...
                when {
                    newPasswordAgainEditText.text.isNullOrEmpty() -> errorNewPasswordAgainTextView.text =
                        getString(R.string.please_confirm_your_new_password)
                    newPasswordAgainEditText.text!!.length < 6 -> errorNewPasswordAgainTextView.text =
                        getString(R.string.password_must_have_at_least_6_characters)
