...
class GetDetections(private val repository: DetectionsRepository,
                    threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread) : SingleUseCase<DetectionFactory, List<Detections>>(threadExecutor, postExecutionThread) {
