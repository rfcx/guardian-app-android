    ...
    fun save(report: Report, attachImages: List<String>) {
        ...
        realm.executeTransaction {
            ...
            attachImages.forEach { attachImage ->
                ...
                val reportImage =
                    ReportImage(imageId, reportId = report.id, localPath = attachImage, createAt = imageCreateAt)
...
// 		val imageDb = ReportImageDb()
    ...
    fun deleteReport(id: Int) {
        ...
        realm.executeTransaction {
            ...
            realm.where(ReportImage::class.java).equalTo(ReportImage.FIELD_REPORT_ID, id)?.findAll()
                ?.deleteAllFromRealm()
        }
    }
